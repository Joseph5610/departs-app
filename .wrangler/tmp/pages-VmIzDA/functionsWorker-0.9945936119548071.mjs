...
var onRequest2 = /* @__PURE__ */ __name(async (context) => {
  const { env } = context;
  const fetchAllStops = /* @__PURE__ */ __name(async () => {
    let allFeatures = [];
    let offset = 0;
    const limit = 1e4;
    while (offset < 4e4) {
...
// ../.wrangler/tmp/bundle-rIQm0q/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-rIQm0q/middleware-loader.entry.ts
