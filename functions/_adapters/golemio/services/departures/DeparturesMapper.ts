...
export class DeparturesMapper {
     ...
     */
    static map(data: GolemioDepartureItem[][], stopIds: string[], connections: LiveConnections | null): AppDepartureResponse {
            ...
            data.forEach((groupData, idx) => {
                if (Array.isArray(groupData)) {
                    ...
                    groupData.forEach(item => {
                        const normalized = this.normalizeDeparture(item, connections);
    ...
    private static normalizeDeparture(item: GolemioDepartureItem, connections: LiveConnections | null): AppDeparture {
