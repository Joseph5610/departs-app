  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 outline-none cursor-pointer",
  {
    variants: {
      variant: {
        ...
        glassy: "bg-white/20 dark:bg-white/10 border border-white/20 backdrop-blur-3xl text-white hover:bg-white/30 active:bg-white/40 transition-all",
        tinted: "glassy-tinted hover:brightness-125 active:brightness-150 transition-all",
      },
      size: {
        default: "h-9 px-4 py-2",
        sm: "h-8 rounded-md px-3 text-xs",
        lg: "h-10 rounded-md px-8",
        xl: "h-12 rounded-3xl px-6 text-base",
