    ...
    return (
        <AnimatePresence mode="wait">
            <motion.div
                ...
                className="absolute top-4 left-1/2 z-10 flex items-center gap-2 px-3 py-1.5 bg-slate-900/60 backdrop-blur-md rounded-full border border-slate-700/30 shadow-2xl pointer-events-none"
            >
