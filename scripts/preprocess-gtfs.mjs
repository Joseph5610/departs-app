...
const CITY = 'brno';
const DATA_DIR = path.join(__dirname, '..', 'functions', '_data', 'cities', CITY);
...
async function main() {
    ...
    // Write individual stop departure files
    console.log(`Writing individual departure files for ${departuresByStop.size} stops...`);
    const publicDeparturesDir = path.join(__dirname, '..', 'public', 'gtfs', CITY, 'departures');
    ...
    console.log(`Successfully wrote ${fileCount} departure files to public directory.`);
