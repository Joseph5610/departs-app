...
- Prague vehicles validate only the shape of Golemio's fleet and type-check fields while mapping, instead of a per-vehicle schema that alone could exceed the Workers CPU limit.
